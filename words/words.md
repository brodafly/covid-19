...
(Бележка относно объркването на пред-симптоматични (преди да проявят симптоми) и "истински" асимптомпатични (които не проявяват симпотми) - "истинските" асимптомпатични случаи са редки:[^rant])
...
3) Провеждане на мерки за постигане на R < 1 докато открием терапии, които успяват силно да намалят нуждата на болните от COVID-19 от интензивни грижи. (Което би трябвало да правим *по принцип!*) Намаляването на нуждата от интезнивни отделения 10 пъти е същото като увеличаването на капацитета 10 пъти:
...
Ето главната идея с някои (не дотам договорени) резервни палнове:
...
Единственото, от което трябва да се страхуваме, е самата идея, че единственото, от което трябва да се страухваме, е самият страх.
